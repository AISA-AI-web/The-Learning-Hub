...
window.AR_BLOCKS = {
    ...
    "<strong>Notice → Record → Report → Act → Review.</strong> A memory aid for the shape of a response — not the reporting route.":
        "<strong>لاحِظ ← سجّل ← أبلِغ ← تصرّف ← راجِع.</strong> وسيلة تذكّر لشكل الاستجابة — لا مسار الإبلاغ.",    "ADEK's full lesson plans and student materials are being bulk-uploaded to <a href=\"https://www.adek.instructwin.com/\" target=\"_blank\" rel=\"noopener\">InstrucTwin</a>, and that upload is still running — so your grade may well not be there yet. Staff accounts are not reliably showing assigned grades either. Both are mine to chase, not yours. When your lesson does appear, read it against the plan you just wrote: yours says what the lesson is for, theirs says how they would run it.":
        "يجري رفع خطط الدروس الكاملة ومواد الطلاب الصادرة عن دائرة التعليم والمعرفة دفعةً واحدة إلى <a href=\"https://www.adek.instructwin.com/\" target=\"_blank\" rel=\"noopener\" class=\"ltr\">InstrucTwin</a>، ولا يزال الرفع جارياً — لذا قد لا يكون صفّك متاحاً بعد. كما أنّ حسابات الطاقم لا تُظهر الصفوف المُسنَدة بشكل موثوق. ومتابعة الأمرين من مسؤوليتي لا من مسؤوليتك. وحين يظهر درسك، اقرأه في ضوء الخطة التي كتبتَها للتو: خطتك تقول ما الغاية من الدرس، ودرسهم يقول كيف يقترحون تقديمه.",
    ...
    "Teaching begins <strong>the week of 21 September 2026</strong> — your first lesson falls somewhere in that week, not necessarily on the Monday. ADEK is bulk-uploading the full curriculum, lesson plans and teacher toolkits to InstrucTwin now; that upload is still running, so your grade may not be there yet.":
        "يبدأ التدريس في <strong>أسبوع 21 سبتمبر 2026</strong> — فدرسك الأوّل يقع في موضع ما من ذلك الأسبوع، وليس بالضرورة يوم الاثنين. وتعمل دائرة التعليم والمعرفة حالياً على رفع المنهج الكامل وخطط الدروس وحقائب المعلّم دفعةً واحدة إلى <span class=\"ltr\">InstrucTwin</span>، ولا يزال الرفع جارياً، لذا قد لا يكون صفّكم متاحاً بعد.",
