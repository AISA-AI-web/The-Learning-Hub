...
(function () {
    ...
    window.AISA_HUB_INDEX = [
        ...
        { title: "Teacher Assistant Performance Report", desc: "Fillable annual TA performance review — rate each indicator, add comments and goals, print or save as PDF.", url: "Tools%20and%20Resources/teacher-assistant-performance-report.html", type: "Form", icon: "📊", keywords: "teacher assistant ta performance report evaluation appraisal review form 2025 2026 fillable printable pdf ratings professional behavior instructional support health safety personnel" },
        { title: "Admin Support Staff Review", desc: "Fillable annual performance review for administrative and support staff — print or save as PDF.", url: "Tools%20and%20Resources/admin-support-staff-evaluation.html", type: "Form", icon: "📊", keywords: "admin support staff performance review evaluation appraisal form 2025 2026 fillable printable pdf customer service ratings office secretary receptionist personnel" },
        { title: "Hallway / Bus Monitor Report", desc: "Fillable performance report for hallway and bus monitors — rate indicators, add remarks, print or save as PDF.", url: "Tools%20and%20Resources/hallway-bus-monitor-report.html", type: "Form", icon: "📊", keywords: "hallway bus monitor performance report evaluation appraisal form 2025 2026 fillable printable pdf supervision ratings professional behavior health safety personnel" },
        ...
        { title: "Digital Lion Newsletter — June 17", desc: "Issue No. 4: Year-end roundup — Hub sign-in, auto-generated certificates, Gemini in Calendar, Drive mobile scanner, Classroom standards, Chalkie.ai feedback, ADEK Aug/Sept, MagicSchool podcasts vs NotebookLM.", url: "Media%20Hub/jun17.html", type: "Newsletter", icon: "🦁", keywords: "newsletter digital lion june 17 issue 4 year end roundup hub email authentication sign in progress tracking dashboard certificates auto generated pd modules slt admins notifications gemini calendar schedule modify cancel meetings prompting google drive mobile scanner classroom standards learning outcomes student progress chalkie ai trial 45 day feedback magicschool podcast creator notebooklm antigravity hall pass adek mandatory training august ai literacy curriculum september school readiness self assessment performance review forms coming soon" },
